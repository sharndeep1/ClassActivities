...
// Because forEach does not create an array, we MUST create the array ourselves before we use the forEach method
const lingo = [];
data.forEach(user => {
...
classes.forEach((htmlElement,i) => {
  htmlElement.textContent =`I have changed the context,class  week is now ${i}`
});
